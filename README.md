...
Processed and analyzed global WHO datasets to explore infection and mortality trends across 200+ countries. Built interactive geographic heatmaps using ggplot2 and Shiny for spatiotemporal analysis, and applied web scraping (rvest) to examine correlations between media coverage and case growth.
